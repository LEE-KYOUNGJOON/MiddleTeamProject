...
<body>
	...
	<div class="div-userinput">
			<div class="div-checkbox">
				...
				<div class="a-list">
				<a href="./FindID.jsp" style="font-size: 13px; line-height: 46px; text-decoration: none;">아이디찾기 | </a> 
				<a href="./FindPW.jsp" style="font-size: 13px; line-height: 46px; text-decoration: none;">비밀번호찾기 | </a>
				<a href="../member/signup" style="font-size: 13px; line-height: 46px; text-decoration: none;">회원가입</a>
				</div>
			</div>	
		</div>
